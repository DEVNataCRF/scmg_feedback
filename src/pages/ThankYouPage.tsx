...
function ThankYouPage() {
  ...
  return (
    <Container>
      ...
      <Text>Sua opinião é muito importante para nós.</Text>
      <FeedbackContainer>
        <FeedbackLabel>Deixe aqui suas sugestões para melhorias:</FeedbackLabel>
        <FeedbackTextarea
          value={feedback}
      ...
      <ButtonContainer>
        <Button onClick={handleSubmit} primary disabled={loading}>
          {loading ? 'Enviando...' : 'Enviar Sugestões'}
        </Button>
        <Button onClick={() => navigate('/')} disabled={loading}>
          Voltar sem Sugestões
        </Button>
      </ButtonContainer>
