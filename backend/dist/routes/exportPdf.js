...
router.get('/export/pdf', async (req, res) => {
    ...
    doc.fontSize(10).fillColor('#888').text(`Gerado por: ${(user === null || user === void 0 ? void 0 : user.name) || (user === null || user === void 0 ? void 0 : user.email) || 'Desconhecido'}`, startX, doc.page.height - 50);
    doc.end();
});
